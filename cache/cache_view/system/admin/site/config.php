...
<form action="<?php echo $this->_context->url('site::config@admin'); ?>" method="post" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
