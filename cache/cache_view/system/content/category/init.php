<?php defined('IN_Next') or exit('No permission resources.'); ?><div class="pageContent">
  <div class="panelBar">
    <ul class="toolBar">
      <li><a class="add" href="<?php echo $this->_context->url('category::add@content'); ?>" target="dialog" mask="true" maxable="false" rel="content_category_add" width="800" height="260"><span>添加栏目</span></a></li>
    </ul>
  </div>
