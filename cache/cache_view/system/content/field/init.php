<?php defined('IN_Next') or exit('No permission resources.'); ?><div class="pageContent">
  <div class="panelBar">
    <ul class="toolBar">
      ...
      <li><a class="icon" href="<?php echo $this->_context->url('field::priview@content','modelid/'.$modelid); ?>" target="dialog" mask="true" maxable="false" rel="content_file_priview" width="1000" height="600"><span>预览模型</span></a></li>
    </ul>
  </div>
