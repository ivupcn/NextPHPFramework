    ...
    <div class="pageFormContent" layoutH="52">
    	<fieldset>
		    ...
		    <tr>
		        ...
		        <td><input type="text" name="info[tagname]" id="tagname" class="required input-text" value="<?php echo $info['tagname'];?>" /></td>
		    </tr>
		    <tr>
		        <th width="100">描述：</th>
		        <td><textarea name="info[description]" maxlength="255" style="width:250px;height:60px;"><?php echo $info['description'];?></textarea></td>
		    </tr>
		    <tr>
		        <th width="100">工作流：</th>
		        <td>
		...
		<fieldset>
		    ...
		    <table width="100%" class="table_form contentWrap">
		    	<tr>
			        ...
			        <td><input name='setting[presentpoint]' type='text' value='<?php echo $setting['presentpoint'];?>' size='5' maxlength='5' class="required number input-text" style='text-align:center' /></td>
		    	</tr>
		    </table>
		</fieldset>
