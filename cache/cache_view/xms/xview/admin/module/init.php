<?php defined('IN_Next') or exit('No permission resources.'); ?><div class="pageContent">
    <table class="table" width="100%">
		...
		?>  
			...
			<td align="center"> 
			<?php if ($modules[$d]['iscore']) {?><font color="#999">禁止</font><?php } else {?><a href="<?php echo $this->_context->url('module::uninstall@admin','module/'.$d); ?>" target="dialog" mask="true" maxable="false" rel="admin_module_uninstall" width="500" height="250"><font color="red">卸载</font></a><?php }?>
			</td>
			</tr>
		<?php 
			} else {  
		...
		?>
			...
			<td align="center">
			<?php if ($isinstall!='无法安装') {?> <a href="<?php echo $this->_context->url('module::install@admin','module/'.$d); ?>" target="dialog" mask="true" maxable="false" rel="admin_module_install" width="500" height="250"><font color="#009933"><?php echo $isinstall?></font><?php } else {?><font color="#009933"><?php echo $isinstall?></font><?php }?></a>
			</td>
			</tr>
		<?php 
				}
