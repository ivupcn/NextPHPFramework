...
<form action="<?php echo $this->_context->url('reol::add@user'); ?>" method="post" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
