...
<div class="nav_bar">
	<div class="nav_box">
		<ul class="sort sort_profile S_line2 clearfix">
			...
			<li class="item<?php if(ROUTE_A == $_value['a']) { ?> current<?php } ?>"><a class="item_link S_func1" href="<?php echo $this->_context->url($_value['c'].'::'.$_value['a'].'@'.$_value['m'],'callback/0/menuid/'.$_GET['menuid']);?>"><?php echo $_value['name'];?></a><div class="W_tabarrow S_bg4"></div></li>
			<?php } ?>
		</ul>
		<div class="right_bar">
			<div class="input_bar">
