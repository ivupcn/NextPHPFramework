 ...
 */
var NextPHPChromeDebugLogger = function()
{
    /**
     * @var string
     */
    var HEADER_NAME = "x-nextphpchromedebug-data";
    ...
    return {
        ...
        init : function()
        {
            ...
            chrome.extension.sendRequest("isActive", function(response) {
                ...
                return NextPHPChromeDebugLogger.initStorage();
            });
        }
    };
} ();

NextPHPChromeDebugLogger.init();
