...
class arr
{
     ...
     *     array('id' => 2, 'value' => '2-1'),
     * );
     * $hashmap = arr::tohashmap($rows, 'id', 'value');
     *
     * dump($hashmap);
     *   // 输出结果为
     *   // array(
     ...
     * );
     * $values = arr::groupby($rows, 'parent');
     *
     * dump($values);
     *   // 按照 parent 分组的输出结果为
     *   // array(
     ...
     * );
     *
     * $tree = arr::totree($rows, 'id', 'parent', 'nodes');
     *
     * dump($tree);
     *   // 输出结果为：
     *   // array(
     ...
     * @code php
     * $refs = null;
     * $tree = arr::totree($rows, 'id', 'parent', 'nodes', $refs);
     * 
     ...
     * );
     *
     * $rows = arr::sortbycol($rows, 'id', SORT_DESC);
     * dump($rows);
     * // 输出结果为：
     * // array(
     * //   array('id' => 6, 'value' => '6-1', 'parent' => 3),
     ...
     * 用法：
     * @code php
     * $rows = arr::sortbymulticols($rows, array(
     *     'parent' => SORT_ASC, 
     *     'name' => SORT_DESC,
     * ));
     * @endcode
