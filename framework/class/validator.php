...
abstract class validator
{
    ...
    static function validateByArgs($validation, array $args)
    {
        ...
        {
            $internal_funcs = array('between','between_length', 'equal', 'greater_or_equal',
                'greater_than', 'is_alnum', 'is_alnumu', 'is_alpha', 'is_ascii','is_code',
                'is_binary', 'is_cntrl', 'is_date', 'is_datetime', 'is_digits',
                'is_domain', 'is_email', 'is_float', 'is_graph', 'is_int', 'is_array',
     ...
     *
     * @param mixed $value
     * @param int|float $min_length
     * @param int|float $max_length
     *
     * @return boolean
     */
    static function validate_between_length($value, $min_length, $max_length)
    {
     ...
     * @return boolean
     */
    static function validate_is_array($value)
    {
     ...
     * @return boolean
     */
    static function validate_is_code($value)
    {
        $session_storage = 'session'.Next::config('system','session_storage','File');
        Next::loadClass($session_storage,1);
    ...
    {
        return preg_match('/http:\/\/(.+)\/$/i', $value);
    }
}
