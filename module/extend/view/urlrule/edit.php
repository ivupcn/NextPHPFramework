	    ...
	    <div class="pageFormContent" layoutH="52">
	      <table width="100%" class="table_form contentWrap">
		    ...
		    <tr> 
		      ...
		      <td>
		      	<label><input type="radio" value="1" name="info[ishtml]"<?php if($ishtml) echo ' checked';?> />是</label>
        		<label><input type="radio" value="0" name="info[ishtml]"<?php if(!$ishtml) echo ' checked';?> />否</label>
		      </td>
		    </tr>
		    <tr> 
