<div class="pageContent">
  <form action="{url 'workflow::edit@extend'}" method="post" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
    <div class="pageFormContent" layoutH="52">
      <table width="100%" class="table_form contentWrap">
        <tr>
          <th width="150">工作流名称：</th>
          <td><input type="text" name="info[workname]" class="required input-text" alt="请输入工作流名称" value="{$workname}" /></td>
        </tr>
        <tr>
          <th>描述：</th>
          <td><textarea name="info[description]" maxlength="255" style="width:100%;height:60px;">{$description}</textarea></td>
        </tr>
        <tr>
          <th>审核级数：</th>
          <td>
