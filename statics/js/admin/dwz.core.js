...
if($("#navTab").length>0) navTab.init();
...
var $this=$(this);
var op={html5Upload:false,skin:'default',cleanPaste:2,internalScript:true,inlineScript:true,linkTag:true,beforeSetSource:ubb2html,beforeGetSource:html2ubb,tools:$this.attr("tools")||'full'};
var upAttrs=[["upLinkUrl","upLinkExt","zip,rar,txt,xsl,doc,docx,xslx"],["upImgUrl","upImgExt","jpg,jpeg,gif,png,bmp"],["upFlashUrl","upFlashExt","swf"],["upMediaUrl","upMediaExt","flv,mp4"]];
...
var op={sites$:">ul>li",boxTitle$:">a>span"};
return this.each(function(){
var $this=$(this);
$this.click(function(){
...
var $box=$("#"+json.rel);
$box.ajaxUrl({
type:"GET",url:json.forwardUrl,callback:function(){
...
var msg="上传文件的总数："+queueData.uploadsSuccessful+"<br/>"+"上传的错误总数："+queueData.uploadsErrored+"<br/>"+"上传的字节总数："+queueData.queueBytesUploaded+"<br/>"+"所有上传的文件的平均速率："+queueData.averageSpeed;
...
var option=$(this);
options+="<li class=\""+ (value==option[0].value?"selected":"") +"\"><a href=\"#\" value=\"" + option[0].value + "\">"+option[0].text+"</a></li>";});
options+="</ul>";
$("body").append(options);
$this.after(select);
